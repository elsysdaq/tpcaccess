...
#  endif
#  pragma warning(disable : 4244) /* disable type-narrowing warnings */
    ...
    DBGLOG(RECV, SOAP_MESSAGE(fdebug, "\n---- compressed ----\n"));
		...
		if ((soap->mode & SOAP_IO) == SOAP_IO_CHUNK) /* read HTTP chunked transfer */ {
			for (; ; ) {
				...
				do
					*t++ = (char)c;      while (soap_isxdigit((int)(c = soap_getchunkchar(soap))) && t - tmp < 7);
				while ((int)c != EOF && c != '\n')
...
again:
  ...
  { register int i;
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_xop_forward(struct soap *soap, unsigned char **ptr, int *size, char **id, char **type, char **options) { /* Check MTOM xop:Include element (within hex/base64Binary) */
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_dime_forward(struct soap *soap, unsigned char **ptr, int *size, char **id, char **type, char **options) {
...
#define IP_MULTICAST_IF 2
	...
	SOAP_SOCKET
        ...
        { soap->error = SOAP_FD_EXCEEDED;
          return SOAP_INVALID_SOCKET;	/* Hint: MUST increase FD_SETSIZE */
				...
				if (soap->accept_timeout || soap->send_timeout || soap->recv_timeout)
				SOAP_SOCKNONBLOCK(soap->master) else
  ...
  soap->zlib_state = SOAP_ZLIB_NONE;
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_embed(struct soap *soap, const void *p, const struct soap_array *a, int n, const char *tag, int type) {
		register int i;
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_pointer_enter(struct soap *soap, const void *p, const struct soap_array *a, int n, int type, struct soap_plist **ppp) {
		register size_t h;
		register struct soap_plist *pp;
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_array_pointer_lookup(struct soap *soap, const void *p, const struct soap_array *a, int n, int type, struct soap_plist **ppp) {
		register struct soap_plist *pp;
		*ppp = NULL;
		if (!p || !a->__ptr)
			return 0;
  ...
  if (soap->ssl)
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_attachment(struct soap *soap, const char *tag, int id, const void *p, const struct soap_array *a, const char *aid, const char *atype, const char *aoptions, int n, const char *type, int t) {
#ifndef WITH_NOIDREF
		struct soap_plist *pp;
		int i;
...
{ soap_set_logfile(soap, SOAP_INDEX_TEST, logfile);
  ...
  { copy->z_buf = (char*)SOAP_MALLOC(copy, SOAP_BUFLEN);
	...
	SOAP_FMAC1
	void
		SOAP_FMAC2 soap_init(struct soap *soap) {
  ...
  soap->c_locale = newlocale(LC_ALL_MASK, "C", NULL);
	...
	SOAP_FMAC1
	void
		SOAP_FMAC2 soap_init1(struct soap *soap, soap_mode mode) {
	...
	SOAP_FMAC1
	void
		SOAP_FMAC2 soap_init2(struct soap *soap, soap_mode imode, soap_mode omode) {
		soap_init(soap);
...
{ unsigned long n = 0;
  ...
  { const char *s = strchr(tag, ':');
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_element_id(struct soap *soap, const char *tag, int id, const void *p, const struct soap_array *a, int n, const char *type, int t) {
		if (!p) {
...
#endif
#ifndef WITH_LEAN
		if (soap->mode & SOAP_XML_CANONICAL) { /* TODO: consider using this code to handle default namespace bindings
  ...
  { if (!soap->peeked && !soap_string_in(soap, 3, -1, -1))
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_set_attr(struct soap *soap, const char *name, const char *value) {
		register struct soap_attribute *tp;
		if (*name == '-')
			return SOAP_OK;
...
# endif
  ...
  sprintf_l(s, soap->c_locale, soap->double_format, n);
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_outunsignedByte(struct soap *soap, const char *tag, int id, const unsigned char *p, const char *type, int n) {
		if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, p, n), type)
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_outunsignedShort(struct soap *soap, const char *tag, int id, const unsigned short *p, const char *type, int n) {
		if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, p, n), type)
			|| soap_string_out(soap, soap_unsignedLong2s(soap, (unsigned long)*p), 0))
			return soap->error;
		return soap_element_end_out(soap, tag);
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_outunsignedInt(struct soap *soap, const char *tag, int id, const unsigned int *p, const char *type, int n) {
		if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, p, n), type)
			|| soap_string_out(soap, soap_unsignedLong2s(soap, (unsigned long)*p), 0))
			return soap->error;
		return soap_element_end_out(soap, tag);
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_outunsignedLong(struct soap *soap, const char *tag, int id, const unsigned long *p, const char *type, int n) {
		if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, p, n), type)
    ...
    *p = strtoull(s, &r, 10);
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_s2string(struct soap *soap, const char *s, char **t) {
		if (s) {
			if (!(*t = soap_strdup(soap, s)))
				return soap->error = SOAP_EOM;
			if (!(soap->mode & (SOAP_ENC_LATIN | SOAP_C_UTFSTRING))) { /* TODO: consider truncating UTF8 to ASCII for regular XML attribute strings? */
			}
		}
		return soap->error;
	}
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_s2QName(struct soap *soap, const char *s, char **t) {
		if (s) {
			soap->labidx = 0;
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_s2wchar(struct soap *soap, const char *s, wchar_t **t) {
		if (s) {
			wchar_t *r;
  ...
  return soap->count;
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_set_dime_attachment(struct soap *soap, char *ptr, size_t size, const char *type, const char *id, unsigned short optype, const char *option) {
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_set_mime_attachment(struct soap *soap, char *ptr, size_t size, enum soap_mime_encoding encoding, const char *type, const char *id, const char *location, const char *description) {
...
{ int i;
		...
		if (k == 0) {
			...
			if (s && httpcmd) {
				...
				if (httpcmd > 1) {
					switch (httpcmd) {
						case  2:
							soap->error = soap->fget(soap); break;
						case  3:
							soap->error = soap->fput(soap); break;
						case  4:
							soap->error = soap->fdel(soap); break;
						case  5:
							soap->error = soap->fhead(soap); break;
						default:
							soap->error = SOAP_HTTP_METHOD; break;
					}
					if (soap->error == SOAP_OK)
						soap->error = SOAP_STOP; /* prevents further processing */
					return soap->error;
  ...
  if (soap_putsetcookies(soap))
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_recv_fault(struct soap *soap) {
		register int status = soap->error;
    ...
    *soap->msgbuf = '\0';
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_set_sender_error(struct soap *soap, const char *faultstring, const char *faultdetailXML, int soaperror) {
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_set_receiver_error(struct soap *soap, const char *faultstring, const char *faultdetailXML, int soaperror) {
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_sender_fault_subcode(struct soap *soap, const char *faultsubcodeQName, const char *faultstring, const char *faultdetailXML) {
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_receiver_fault_subcode(struct soap *soap, const char *faultsubcodeQName, const char *faultstring, const char *faultdetailXML) {
	...
	SOAP_FMAC1
	int
		SOAP_FMAC2 soap_register_plugin_arg(struct soap *soap, int (*fcreate)(struct soap*, struct soap_plugin*, void*), void *arg) {
