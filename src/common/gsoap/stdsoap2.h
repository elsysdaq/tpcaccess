...
#  if __has_include("bits/wordsize.h")
...
#ifndef SOAP_BUFLEN
# ifndef WITH_LEAN
#  define SOAP_BUFLEN (1048576) /* buffer length for socket packets, also used by gethostbyname_r and UDP messages, so don't make this too small */
# else
#  define SOAP_BUFLEN  (1048576)
# endif
#endif
#ifndef SOAP_LABLEN
