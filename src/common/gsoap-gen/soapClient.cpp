...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.7.12 2026-01-13 14:49:35 GMT")
...
{	struct ns__GetAllParametersAvailableValues soap_tmp_ns__GetAllParametersAvailableValues;
	...
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize_ns__GetAllParametersAvailableValues(soap, &soap_tmp_ns__GetAllParametersAvailableValues);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_ns__GetAllParametersAvailableValues(soap, &soap_tmp_ns__GetAllParametersAvailableValues, "ns:GetAllParametersAvailableValues", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	response.soap_get(soap, "ns:ParameterAvailableValuesList", "");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
{	struct ns__GetInputRanges soap_tmp_ns__GetInputRanges;
	...
	soap->encodingStyle = "";
	soap_tmp_ns__GetInputRanges.boardAddress = boardAddress;
	soap_tmp_ns__GetInputRanges.inputNumber = inputNumber;
	soap_tmp_ns__GetInputRanges.inputType = inputType;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize_ns__GetInputRanges(soap, &soap_tmp_ns__GetInputRanges);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_ns__GetInputRanges(soap, &soap_tmp_ns__GetInputRanges, "ns:GetInputRanges", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (!&result)
		return soap_closesock(soap);
	soap_default_ns__InputRangesList(soap, &result);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_ns__GetInputRangesResponse = soap_get_ns__GetInputRangesResponse(soap, NULL, "ns:GetInputRangesResponse", "");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	result = soap_tmp_ns__GetInputRangesResponse->result;
	return soap_closesock(soap);
}
...
{	struct ns__GetBitReadoutErrors soap_tmp_ns__GetBitReadoutErrors;
	soap->encodingStyle = "";
	soap_tmp_ns__GetBitReadoutErrors.boardAddress = boardAddress;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize_ns__GetBitReadoutErrors(soap, &soap_tmp_ns__GetBitReadoutErrors);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_ns__GetBitReadoutErrors(soap, &soap_tmp_ns__GetBitReadoutErrors, "ns:GetBitReadoutErrors", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_ns__BitReadoutTestResult(soap, &result, "ns:BitReadoutTestResult", "");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
{	struct ns__WritePhaseParameters soap_tmp_ns__WritePhaseParameters;
	soap->encodingStyle = "";
	soap_tmp_ns__WritePhaseParameters.boardAddress = boardAddress;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize_ns__WritePhaseParameters(soap, &soap_tmp_ns__WritePhaseParameters);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_ns__WritePhaseParameters(soap, &soap_tmp_ns__WritePhaseParameters, "ns:WritePhaseParameters", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
