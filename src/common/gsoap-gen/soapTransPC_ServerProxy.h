	...
	{ soap = soap_new(); endpoint = "http://localhost:80"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	/// Invoke 'GetAllParametersAvailableValues' of service 'TransPC_Server' and return error code (or SOAP_OK)
	...
	/// Invoke 'GetInputRanges' of service 'TransPC_Server' and return error code (or SOAP_OK)
	...
	/// Invoke 'GetBitReadoutErrors' of service 'TransPC_Server' and return error code (or SOAP_OK)
	...
	/// Invoke 'WritePhaseParameters' of service 'TransPC_Server' and return error code (or SOAP_OK)
