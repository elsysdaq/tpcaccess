...
//---------------------------------------------------------------------------
/*--------------------------------------------------------------------------------
  $Id: System.h 46 2025-03-21 10:42:51Z philipp $
...
class System {
   public:
    ...
    int NumDevices();
    TPC_ErrorCode GetDeviceUrl(int index, std::string& url);
    ...
    TPC_ErrorCode GetInputInfo(int deviceIx, int boardAddress, int inputNumber, TPC_InputInfo* inputInfo,
                               int structSize);
    TPC_ErrorCode GetInputRanges(int deviceIx, int boardAddress, int inputNumber, int inputType, double* inputRanges,
                                 int size);
    ...
    void GetSortedDevicesList(std::vector<Device*>& devices);
    ...
    void GetTimebaseParameterList(std::vector<TPC_Parameter>& parameters);
    TPC_ErrorCode GetAllClusterNumbers(std::vector<int>& clusterNumbers);
    ...
    TPC_ErrorCode GetAttribute(int deviceIx, int boardAddress, int inputNumber, const char* key, std::string& value);
    TPC_ErrorCode GetAllAttributes(int deviceIx, TPC_AttributeEnumeratorCallback callback, void* userData);
    TPC_ErrorCode GetAssociatedChannels(int deviceIx, int boardAddress, int inputNumber, TPC_AssociatedChannel* list,
                                        int* count);
    TPC_ErrorCode SetAssociatedChannels(int deviceIx, int boardAddress, int inputNumber, TPC_AssociatedChannel* list,
                                        int count);
    TPC_ErrorCode SetTrigger(int deviceIx, int boardAddress, int inputNumber, TPC_EasyTriggerMode mode,
                             TPC_EasyTriggerComperatorMode comp, TPC_EasyTriggerFlags flags, double level,
                             double hysteresis, int time, int time2);
    TPC_ErrorCode GetTrigger(int deviceIx, int boardAddress, int inputNumber, TPC_EasyTriggerMode* mode,
                             TPC_EasyTriggerComperatorMode* comp, TPC_EasyTriggerFlags* flags, double* level,
                             double* hysteresis, int* time, int* time2);
    ...
    // Data readout
    TPC_ErrorCode GetYMetaData(int deviceIx, int boardAddress, int inputNumber, int measurementNumber,
                               TPC_YMetaData* metaData, int structSize);
    TPC_ErrorCode GetMetaDataParameter(int deviceIx, int boardAddress, int inputNumber, int measurementNumber,
                                       TPC_Parameter parameter, double* value);
    TPC_ErrorCode GetMetaDataAttribute(int deviceIx, int boardAddress, int inputNumber, int measurementNumber,
    ...
    TPC_ErrorCode GetMetaDataAssociatedChannels(int deviceIx, int boardAddress, int inputNumber, int measurementNumber,
                                                TPC_AssociatedChannel* list, int* count);

    TPC_ErrorCode GetTMetaData(int deviceIx, int boardAddress, int blockNumber, int measurementNumber,
                               TPC_TMetaData* metaData, int structSize);
    TPC_ErrorCode GetTMetaData(int deviceIx, int boardAddress, int blockNumberFrom, int blockNumberTo,
                               int measurementNumber, TPC_TMetaData* metaData, int structSize);

    TPC_ErrorCode GetData(int deviceIx, int boardAddress, int inputNumber, int blockNumber, int measurementNumber,
                          uint64_t dataStart, uint64_t dataLength, int resultLength, double* data,
                          Device::ReadoutType type);
    TPC_ErrorCode GetRawData(int deviceIx, int boardAddress, int inputNumber, int blockNumber, int measurementNumber,
                             uint64_t dataStart, uint64_t dataLength, int resultLength, int32_t* data,
                             Device::ReadoutType type);

    TPC_ErrorCode DeferredGetData(int deviceIx, int boardAddress, int inputNumber, int blockNumber, uint64_t dataStart,
    ...
    TPC_ErrorCode WriteDev(int deviceIx, int boardAddress, int type, unsigned count, void* data, unsigned aux1,
                           unsigned aux2);
    TPC_ErrorCode ReadDev(int deviceIx, int boardAddress, int type, unsigned count, void* data, unsigned aux1,
                          unsigned aux2);
