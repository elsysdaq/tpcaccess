...
def TPC_GetParameter(deviceIx: 'int', boardAddress: 'int', inputNumber: 'int', parameter: 'enum TPC_Parameter', value: 'double *') -> "enum TPC_ErrorCode":
    return _TpcAccess.TPC_GetParameter(deviceIx, boardAddress, inputNumber, parameter, value)
...
def TPC_MakeMeasurement(timeout: 'int', measurementNumber: 'int *') -> "enum TPC_ErrorCode":
    return _TpcAccess.TPC_MakeMeasurement(timeout, measurementNumber)
...
def TPC_GetMetaDataParameter(deviceIx: 'int', boardAddress: 'int', inputNumber: 'int', measurementNumber: 'int', parameter: 'enum TPC_Parameter', value: 'double *') -> "enum TPC_ErrorCode":
    return _TpcAccess.TPC_GetMetaDataParameter(deviceIx, boardAddress, inputNumber, measurementNumber, parameter, value)
